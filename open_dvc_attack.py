...
from generate_folder_npy import generate

# Step 1: Load the Vimeo90K dataset
# Load from directory here
path = ""
(x_train, y_train), (x_test, y_test), min_pixel_value, max_pixel_value = generate()

# Step 2: Create the model (in this case, load from pretrained
model_path = ""
# load model here
...
attack = FrameSaliencyAttack(classifier=classifier,
